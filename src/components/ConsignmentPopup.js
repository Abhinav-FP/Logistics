      ...
      <div className="py-6 p-6 md:px-8 lg:px-16">
        ...
        <div className="flex flex-wrap -mx-2">
          ...
          <div className="w-full md:w-4/12 px-2 mb-3 lg:mb-5">
            <div
              className={`${
                condition === "damaged" ? "border border-[#C2970A]" : ""
          ...
          <div className="w-full md:w-4/12 px-2 mb-3 lg:mb-5">
            <div
              className={`${
                condition === "reject" ? "border-3 border-[#CF0000]" : ""
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 lg:gap-5 mt-6">
          ...
          <button
            className="bg-white hover:bg-[#0a3fab] border boder-black border-opacity-10 inline-block font-medium text-base text-[#1B1B1B] hover:text-white tracking-[-0.04em] rounded-lg lg:rounded-xl px-16 py-3 uppercase"
            onClick={() => {
              onClose();
            }}
          >
