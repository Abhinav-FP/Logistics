      ...
      >
        <div className="px-3 md:px-4 lg:px-6">
          <div className="flex items-center border-b border-gray-200  py-4 lg:py-6 ">
            <img src="/Truck.png" alt="FriegtFlow Logo" className="h-[41px] w-[98px] mr-2" />
        ...
        <div className="px-3 md:px-4 lg:px-6 py-4 lg:py-5">
          ...
          <div className="mb-4 font-medium">
            ...
            <ul className="mt-2 space-y-1 mb-10">
              ...
              <Link
                href="/shipment"
                className={`flex items-center py-2.5 px-2.5 gap-2 text-[#727272] text-base font-medium tracking-[-0.06em] ${pathname?.startsWith("/shipment")
              ...
              <Link
                href="/settings"
                className={`flex items-center py-2.5 px-2.5 gap-2 text-[#727272] text-base font-medium tracking-[-0.06em] ${pathname === "/settings"
                    ? "text-blue-500 bg-blue-100"
                    : "hover:bg-gray-100"
                  } rounded-md`}
              >
