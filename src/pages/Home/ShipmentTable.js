                ...
                {role === "shipper" ? (
                  ...
                  <td className="px-3 py-5 text-[#1D1D42] tracking-[-0.04em] text-sm font-medium text-left">
                    <div className="relative">
                      ...
                      <div
                        className={`fixed min-w-[150px] right-0 mt-2 border border-black border-opacity-10 rounded-xl z-10 bg-white shadow-xl transition-all duration-200 ease-in-out ${
