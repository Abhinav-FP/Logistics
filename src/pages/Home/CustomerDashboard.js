  ...
  return (
    <div>
      ...
      <div className="bg-white mt-6 lg:mt-[30px] px-6 py-[30px] rounded-md lg:rounded-xl border border-black border-opacity-10">
        ...
        <ShipmentTable shipments={listing?.ShipmentData} role={"customer"} />
      </div>
        ...
        <div className="flex flex-wrap -mx-[2.5] ">
          ...
          <div className='w-full lg:w-6/12 px-2.5'>
            ...
            <iframe 
                ...
                src={`https://www.google.com/maps/embed/v1/directions?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&origin=${listing && listing?.ShipmentData && listing?.ShipmentData[0]?.pickup_location || ""}&destination=${listing && listing?.ShipmentData && listing?.ShipmentData[0]?.drop_location || ""}&mode=driving`}
