  ...
  const data = [
    {
      ...
      customer_id: {
        _id: "6790bad99a5e2d4771c3e822",
        name: "Test Customer",
        email: "customer1@gmail.com",
      },
      status: "pending",
      shipper_id: "678a02c5a4bf247b03d1300e",
      broker_id: "678a0854d95317a18e048aa3",
      carrier_id: null,
      driver_id: null,
      shippingDate: "2025-02-04",
      deliveryDateExpect: "2025-02-08",
      cost: 200000,
      ...
      dimensions: "20 x 10",
      typeOfGoods: "food",
      created_at: "2025-02-04T06:33:49.433Z",
      __v: 0,
    },
  ];
      ...
      <div className="bg-white mt-6 lg:mt-[30px] px-6 py-[30px] rounded-md lg:rounded-xl border border-black border-opacity-10">
        ...
        {/* <div className="w-full px-2 flex flex-wrap justify-between">
                      <div className="relative mr-4">
                        ...
                        <input
                          type="text"
                          className="w-full h-[38px] appearance-none block bg-white text-[#000] text-base border border-black border-opacity-10 rounded-md lg:rounded-xl py-2 pr-4 pl-10 leading-tight focus:outline-none"
                        />
                      </div>
        ...
        <ShipmentTable shipments={data} role={"customer"} />
      </div>
              ...
              {shipmentTracks.map((shipmentTrack, index) => (
                ...
                >
                  <div className="w-full md:w-7/12 pr-3">
                    ...
                    <h3 className="text-[#262626] font-medium text-xl lg:text-2xl tracking-[-0.06em] mb-2">
                      {shipmentTrack?.number}
                    </h3>
                    <div className="flex flex-wrap items-center lg:space-x-2">
                      ...
                      <span className="text-[#666666] text-[13px] tracking-[-0.06em]">
                        {shipmentTrack?.endLocation}
                      </span>
                    </div>
                  </div>
                  <div className="w-full md:w-5/12 text-right">
                    <img
                      src={shipmentTrack?.image}
          ...
          <div className="w-full lg:w-6/12 px-2.5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-1.5 lg:gap-2 xl:gap-3">
              <div className="md:[&:not(:last-child)]:border-r border-black border-opacity-10">
                ...
                <p className="text-base text-[#262626] tracking-[-0.04em] font-medium mb-0">
                  Electronic
                </p>
              </div>
              <div className="md:[&:not(:last-child)]:border-r border-black border-opacity-10">
