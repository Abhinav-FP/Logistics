        ...
        <div className='flex flex-wrap -mx-[2.5] '>
          ...
          <div className='w-full lg:w-6/12 px-2.5'>
            ...
            <div className='space-y-3 lg:space-y-4'>
              {
                shipmentTracks.map((shipmentTrack, index) => (
                  <div key={index} className='border border-black border-opacity-10 p-4 lg:p-5 rounded-md lg:rounded-xl flex flex-wrap'>
                    <div className='w-full md:w-7/12 pr-3'>
                      ...
                      <h3 className='text-[#262626] font-medium text-xl lg:text-2xl tracking-[-0.06em] mb-2'>{shipmentTrack?.number}</h3>
                      <div className='flex flex-wrap items-center lg:space-x-2'>
                        ...
                        <span className='text-[#666666] text-[13px] tracking-[-0.06em]'>{shipmentTrack?.startLocation}</span>
                        ...
                        <span className='text-[#666666] text-[13px] tracking-[-0.06em]'>{shipmentTrack?.endLocation}</span>
                    ...
                    <div className='w-full md:w-5/12 text-right'>
                      <img src={shipmentTrack?.image} className='max-w-full inline' alt='img' />
                    </div>
                  </div>
