      ...
      <div>
        ...
        <Popup isOpen={isPopupOpen} onClose={closePopup}>
          <div className="relative">
            <iframe className="absolute z-1 left-0 top-0" width="100%" src="https://lottie.host/embed/1033fffa-3d5e-4fea-86a0-31a7203dccb3/ZFfNouJGHe.lottie"></iframe>

            <div className="relative z-2">
              <div className="bg-[#15C082] mx-auto mb-10 flex items-center h-[72px] w-[72px] rounded-full justify-center">
              ...
              <div className="border border-black border-opacity-10 rounded-md lg;rounded-xl p-4 lg:p-6">
